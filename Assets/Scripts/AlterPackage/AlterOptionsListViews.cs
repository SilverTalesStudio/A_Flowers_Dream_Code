...
namespace Yarn.Unity
{
    ...
    public class AlterOptionsListViews : DialogueViewBase
    {
        [SerializeField] CanvasGroup canvasGroup;

        [SerializeField] AlterOptionView optionViewPrefab;
        ...
        // A cached pool of AlterOptionView objects so that we can reuse them
        List<AlterOptionView> optionViews = new List<AlterOptionView>();
        ...
        public override void RunOptions(DialogueOption[] dialogueOptions, Action<int> onOptionSelected)
        {
            ...
            /// <summary>
            /// Creates and configures a new <see cref="AlterOptionView"/>, and adds
            /// it to <see cref="optionViews"/>.
            /// </summary>
            AlterOptionView CreateNewOptionView()
            {
            ...
            /// <summary>
            /// Called by <see cref="AlterOptionView"/> objects.
            /// </summary>

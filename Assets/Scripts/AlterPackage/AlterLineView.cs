...
{
    public class AlterLineView : DialogueViewBase
    {
        /// <summary>
        ...
        /// <summary>
        /// Called when the DialogPanel is clicked.
        /// </summary>
        public void OnCompleteDialogueClicked()
        {
            ...
            if (characterNameText == null)
            {
                if (showCharacterNameInLineView)
                {
                    lineText.text = currentLine.Text.Text;
                    length = currentLine.Text.Text.Length;
                }
                else
                {
                    lineText.text = currentLine.TextWithoutCharacterName.Text;
                    length = currentLine.TextWithoutCharacterName.Text.Length;
                }
            }
            else
            {
